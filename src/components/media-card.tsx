    ...
    >
      <figure className="relative overflow-hidden">
        <Image
          ...
          width={400}
          height={400}
          className="block max-w-full h-auto object-cover transition-all duration-300 transform-gpu group-hover:scale-100 group-hover:translate-x-0 group-hover:opacity-85 -translate-x-5 scale-110"
